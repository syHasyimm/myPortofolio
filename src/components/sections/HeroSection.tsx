      ...
      <div className="container mx-auto px-6 z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              Hi, I'm <span className="bg-clip-text text-transparent bg-linear-to-r from-primary to-purple-500">Hasyim</span>
              <br />
              <motion.span 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }} 
                href="#contact" 
                className={buttonVariants({ size: "lg", className: "rounded-full shadow-lg shadow-primary/25 h-12 px-8" })}
              >
              ...
              <motion.a 
                ...
                className={buttonVariants({ size: "lg", variant: "outline", className: "rounded-full h-12 px-8" })}
              >
            ...
            >
              <a href="#" className="p-3 rounded-full bg-muted/50 hover:bg-primary hover:text-primary-foreground transition-all hover:scale-110 shadow-sm">
                <FaInstagram size={20} />
              </a>
              <a href="#" className="p-3 rounded-full bg-muted/50 hover:bg-primary hover:text-primary-foreground transition-all hover:scale-110 shadow-sm">
                <FaYoutube size={20} />
