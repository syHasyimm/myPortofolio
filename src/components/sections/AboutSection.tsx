          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center mb-20">
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
                Saya adalah Software Engineer yang berfokus pada penciptaan
                pengalaman digital yang indah dan berperforma optimal. Didorong
                oleh rasa ingin tahu, saya terus berinovasi untuk membangun
                produk web yang solutif.
              </p>
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                Dari aplikasi satu halaman yang minimalis hingga ekosistem
                full-stack yang masif, saya berkomitmen pada standar kode
                tertinggi untuk mengubah setiap proyek menjadi karya digital
                yang sempurna
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  >
                    ...
                    <p className="font-semibold font-outfit text-xl">
                      {item.value}
                    </p>
                  </motion.div>
                ))}
                ...
                >
                  ...
                  {[...techStack, ...techStack, ...techStack].map(
                    (tech, idx) => (
                      ...
                      >
                        <tech.icon
                          className={`text-6xl md:text-7xl ${tech.color}`}
                        />
